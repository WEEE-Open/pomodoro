...
<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 20 20">
		<path :fill="color"
			...
			stroke="#eee" stroke-width="2" paint-order="stroke" />
		<text x="8" y="8" font-size="8" :fill="color" text-anchor="middle" alignment-baseline="middle">{{ text }}</text>
	</svg>
</template>